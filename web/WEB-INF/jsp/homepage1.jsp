...
<!-- 顶部开始 -->
<div class="container">
    <div class="logo"><a href="#">疫情物资管理系统</a></div>
    <div class="left_open">
    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content" >
            <div class="layui-tab-item layui-show o_div" >
                <img style="margin: 30px;width: 1080px;height: 445px;" src="<%=path%>/images/index.jpg" />
            </div>
        </div>
    </div>
</div>
...
<!-- 底部开始 -->
<div class="footer">
<%--    <div class="copyright">Copyright ©2019-2020 猫头鹰版权所有</div>--%>
    <div class="copyright">Copyright ©2019-2020</div>
</div>
<!-- 底部结束 -->
