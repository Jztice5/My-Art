...
<div class="x-body">
    <form class="layui-form"  id="f_auto" action="<%=path%>/updateTpurchase" method="post" >
        <input type="hidden" value="${tpurchase.id}" name="id" id="id"/>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="material" name="material" lay-verify="required"
                       autocomplete="off" value="${tpurchase.material}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="quantity" name="quantity" lay-verify="number"
                       autocomplete="off" value="${tpurchase.quantity}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="unitPrice" name="unitPrice" lay-verify="money"
                       autocomplete="off" value="${tpurchase.unitPrice}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="purseTime" name="purseTime" lay-verify="required"
                       autocomplete="off" value="${tpurchase.purseTime}" class="layui-input">
            </div>
        </div>
...
<script>
    ...
    $('#close').click(function() {
        window.location.href='<%=path%>/findTpurchase';
        return false;
    });
    ...
    $("#category").val('${tpurchase.category}');
