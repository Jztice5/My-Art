<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.ssm.mty.po.Tinput" %>
...
<div class="x-nav">
    ...
    <a class="layui-btn layui-btn-sm" style="line-height:1.6em;margin-top:3px;float:right" href="<%=path%>/findTinput" title="刷新">
        <i class="layui-icon" style="line-height:30px">&#xe669;</i></a>
</div>
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="<%=path%>/findTinput" >
    ...
    <xblock>
        <button id="addTinputBtn" class="layui-btn layui-btn-sm"> <i class="layui-icon">&#xe654;</i>入库登记 </button>
    ...
    <table class="layui-table">
        ...
        <c:forEach items="${pageList.list}" var="di">
            <tr>
                  ...
                  <th>${di.purseTime}</th>
                  <th>${di.registerId}</th>
                  <th>${di.registerTime}</th>
                <c:if test="${sessionScope.type == '03'}">
                <td>
                    <a title="编辑" id= "updateEdit" href="<%=path%>/findTinputById?id=${di.id}">
    ...
    <div class="layui-row" id="test" style="display: none;">
        <div class="layui-col-md10">
            <form class="layui-form" id="addTinputForm">
    ...
    <script>
                ...
                form.on('submit(formDemo)', function(data) {
                    ...
                    $.ajax({
                        ...
                        success:function(){
                            ...
                            setTimeout(function () {window.location.href='<%=path%>/findTinput';},2000);
        ...
        function member_del(obj,id){
            layer.confirm('确认要删除吗？',function(index){
                //发异步删除数据
                $.get("<%=path%>/deleteTinput",{"id":id},function (data) {
                    if(data =true){
